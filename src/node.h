...
public:
        ...
        string buildIR(CFG *cfg)
        {
                ...
                case OP_ADD:
                        ...
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::add,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_SUB:
                        ...
                        retvector.push_back(var2);
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::sub,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_MUL:
                        ...
                        retvector.push_back(var2);
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::mul,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_DIV:
                        ...
                        retvector.push_back(var1);
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::div,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_BIT_AND: // &
                        ...
                        retvector.push_back(var1);
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::bit_and,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_BIT_XOR: // ^
                        ...
                        retvector.push_back(var1);
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::bit_xor,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_BIT_OR: // |
                        ...
                        retvector.push_back(var1);
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::bit_or,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_LOWER: // <
                        ...
                        retvector.push_back(var2);
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::lower,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_GREATER: // >
                        ...
                        retvector.push_back(var2);
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::greater,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_EQUAL:
                        ...
                        retvector.push_back(var2);
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::cmp_eq,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_UNEQUAL:
                        ...
                        retvector.push_back(var2);
                        /* Actual instruction */
                        cfg->current_bb->add_IRInstr(IRInstr::cmp_uneq,
                                                     INT, retvector);
                        return var3;
                ...
                case OP_IFELSE: {
                        ...
                        /* Result of compararaison is stored in var1 */
                        var1 = ndlist[0]->buildIR(cfg);
                        ...
                        cfg->current_bb->add_IRInstr(IRInstr::jmp,
                                                     INT, retvector);
                        ...
                        testBB->add_IRInstr(IRInstr::cmpl,
                                            INT,retvector);
                        afterBB->add_IRInstr(IRInstr::label,
                                             INT, retvector);
                        break;
                }
                ...
                case OP_WHILE: {
                        ...
                        /* test BasicBlock */
                        string testLabel =
                                "testWhileBB" + to_string(counterWhile);
                        string afterlabel =
                                "afterWhileBB" + to_string(counterWhile);
                        BasicBlock *testWhileBB = new BasicBlock(cfg,
                                        testLabel);
                        cfg->add_bb(testWhileBB);
                        BasicBlock *afterWhileBB = new BasicBlock(cfg,
                                        afterlabel);
                        testWhileBB->add_IRInstr(IRInstr::label,
                                                 INT, retvector);
                        ...
                        retvector.push_back(var1);
                        retvector.push_back(afterlabel);
                        testWhileBB->add_IRInstr(IRInstr::cmpl,
                                                 INT, retvector);

                        /* body BasicBlock */
                        BasicBlock *bodyBB = new BasicBlock(cfg, "bodyBB"
                                                            + to_string(counterWhile));
                        cfg->add_bb(bodyBB);
                        cfg->current_bb = bodyBB;
                        ndlist[1]->buildIR(cfg);
                        retvector.push_back(testLabel);
                        cfg->current_bb->add_IRInstr(IRInstr::jmp, INT,
                                                     retvector);

                        /* after BasicBlock */
                        cfg->current_bb = afterWhileBB;
                        afterWhileBB->add_IRInstr(IRInstr::label,
                                                  INT, retvector);
                ...
                case OP_CALL: {
                        if (Verbose) {
                                cout << "Generating IR for function call"
                                     << endl;
                ...
                case OP_ARRAY_ELEMENT: {
                        ...
                        cfg->current_bb->add_IRInstr(IRInstr::array_access,
                                                     INT, retvector);
                        return dest;
                }

                default:
                        cout << "Error while generating IR"
                             << endl;
